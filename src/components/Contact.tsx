      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex flex-col items-center text-center space-y-6">
            ...
            <div>
              <img
                src="https://images.unsplash.com/photo-1672685667592-0392f458f46f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxwcm9mZXNzaW9uYWwlMjBoZWFkc2hvdCUyMHBvcnRyYWl0fGVufDF8fHx8MTc2ODE1MTQ1NXww&ixlib=rb-4.1.0&q=80&w=1080"
                alt="Omofon Udoh"
                className="w-24 h-24 rounded-full object-cover mx-auto mb-4"
              />
              <p className="text-gray-600 dark:text-gray-400 italic max-w-md mx-auto leading-relaxed mb-4">
                Just say hi. I'm always open to discuss your project and take it to the next level
              </p>
